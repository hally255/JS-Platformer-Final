...
function Fast(pos) {
  this.basePos = this.pos = pos.plus(new Vector(0.8, .05));
  this.size = new Vector(0.2, 0.2);
  this.wobble = Math.random();
}
Fast.prototype.type = "fast";

function Norm(pos) {
  this.basePos = this.pos = pos.plus(new Vector(0.8, 0.05));
  this.size = new Vector(0.2, 0.2);
  this.wobble = Math.random() + Math.PI;
}
Norm.prototype.type = "norm";
...
var wobbleSpeedCoin = 8, wobbleDistCoin = 0.2;

Coin.prototype.act = function(step) {
  this.wobble += step * wobbleSpeedCoin;
  var wobblePos = Math.sin(this.wobble) * wobbleDistCoin;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};

var wobbleSpeedHelp = 3, wobbleDistHelp = 0.5;

Fast.prototype.act = function(step) {
  this.wobble += step * wobbleSpeedHelp;
  var wobblePos = Math.sin(this.wobble) * wobbleDistHelp;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};

Norm.prototype.act = function(step) {
  this.wobble += step * wobbleSpeedHelp;
  var wobblePos = Math.sin(this.wobble) * wobbleDistHelp;
  this.pos = this.basePos.plus(new Vector(0, wobblePos));
};
